...
Serilog can call Dispose https://github.com/serilog/serilog-extensions-logging/blob/6c52f28aef1ba24d99d9edcc5da872dbefd36f39/src/Serilog.Extensions.Logging/Extensions/Logging/SerilogLoggerProvider.cs#L42 - but many existed packages for Serilog Configuring uses SerilogLoggerProvider with dispose=false, so, this Sink is designed without IDisposable interface and can work forever without issues.
